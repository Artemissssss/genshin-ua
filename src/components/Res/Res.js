...
if (dayArr.length === 0) return <div>loading</div>;
  return (
    ...
    <Slider className="mainDayResSlider" {...settings}>
<div className="mainDayResSect">
    ...
    <Image  src={"/imgres/"+dayArr[0].mond[1]} width="118" height="118" alt="res img"/>
    </div>
</div>
<div className="mainDayResSect">
    ...
    <Image  src={"/imgres/"+dayArr[0].li[1]} width="118" height="118" alt="res img"/>
    </div>
</div>
<div className="mainDayResSect">
    ...
    <Image  src={"/imgres/"+dayArr[0].ina[1]} width="118" height="118" alt="res img"/>
    </div>
</div>
<div className="mainDayResSect">
    ...
    <Image  src={"/imgres/"+dayArr[0].sum[1]} width="118" height="118" alt="res img"/>
    </div>
</div>
